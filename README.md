...
This repository contains the test files that automate login, cart, and checkout functionalities of the app using the **Page Object Model (POM)**.
...
Create a `.env` file in the project root and add following credentials (this file is ignored by Git):
